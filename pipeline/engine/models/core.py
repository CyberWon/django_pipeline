...
class PipelineProcess(models.Model):
    ...
    snapshot = models.ForeignKey(ProcessSnapshot, null=True, on_delete=models.CASCADE)
...
class PipelineModel(models.Model):
    ...
    process = models.ForeignKey(PipelineProcess, null=True, on_delete=models.CASCADE)
...
class History(models.Model):
    ...
    data = models.ForeignKey(HistoryData,on_delete=models.CASCADE)
